...
load MGV.mat;
MM = MGV;
value_name = {'SilicateC','POC','NH4','Temp','Salt','O2','Si','NO3','NO2','PO4','Chla','DIC'};
...
xlim([-5 max(value)])
ylim([-0.1 max(depth(qc7==3))./1e3]);
text(0,3,{['Data Source:CCHDO'],['Longitude:',num2str(lon(n)),'°E'],['Latitude:',num2str(lat(n)),'°N'],...
