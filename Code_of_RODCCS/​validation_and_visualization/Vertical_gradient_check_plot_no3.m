...
load MGV.mat;
MM = MGV;
value_name = {'NitrateC','POC','NH4','Temp','Salt','O2','Si','NO3','NO2','PO4','Chla','DIC'};
...
ax.XAxisLocation = 'top'; %
ax.YAxisLocation = 'left'; %
text(0,1,{['Data Source:CCHDO'],['Longitude:',num2str(lon(n)),'°E'],['Latitude:',num2str(lat(n)),'°N'],...
